...
/**
 * Servlet implementation class DruglistInsertServlet
 */
@WebServlet("/insert/druglist")
public class DruglistInsertServlet extends HttpServlet {
...
//		System.out.println(h);
		...
		dld.insertDrug(new Drug(null,drugname,chargetype,chufangsyb,chargeclass,drugunit,priceCeiling,yuanneisyb,checking,h));
