...
/**
 * Servlet implementation class StandUpdate2Servlet
 */
@WebServlet("/standpay/update2")
public class StandpayUpdate2Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("structype is " + structype);
		System.out.println("med_per_class is " + med_per_class);
		...
		spd.updateStandPay(new StandPay(spid, i, m, h, sd));
