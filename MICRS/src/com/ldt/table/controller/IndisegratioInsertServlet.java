...
/**
 * Servlet implementation class IndisegratioInsertServlet
 */
@WebServlet("/indisegratio/insert")
public class IndisegratioInsertServlet extends HttpServlet {
...
//		System.out.println(h+"srh");
		...
		isr.insertIndiSegRatio(new IndiSegRatio(null, l, m, h, t, b, br));
