...
/**
 * Servlet implementation class StructInsertServlet
 */
@WebServlet("/insert/struct")
public class StructInsertServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dmid.insertDesiMedIns(new DesiMedIns(null, strucname, h, h1, strucpostcode, legalname, legalphone, cname, cphone, cmphone, loc));
