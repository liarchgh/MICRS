...
public class HospitalClassDaoImpl implements HospitalClassDao {
...
//}
	...
	/*public static void main(String[] args) {
		...
		hh.insertHospitalClass(new HospitalClass("1","wwww"));
		hh.insertHospitalClass(new HospitalClass("4","mmm"));
