            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2 class="drug1">欢迎进入个人基本信息查询！</h2>
                            ...
                            <div class="x_content">
                                ...
                                <div class="row" style="height: auto">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row-fluid">
                                            <form action="/MICRS/query/person" method="post">
                                                <div class="" style="height: 90px;">
                                                    <div id="" style="float: left; mar">
                                                        <span><font color="black">个人编码：</font></span><input type="text" value="" class="input-large"
                                                                                                            name="personid" id="personid" /><br />  <br />
                                                        <span><font color="black">个人名称：</font></span><input
                                                            type="text" value="" class="input-large" name="personname" id="personname" />
                                                    </div>
                                    ...
                                    <table class="table table-striped projects " id="datatable">
                                        <thead>
                                        <tr>
                                            <th style="width: 8%">个人编号</th>
                                            <th style="width: 10%">个人名称</th>
                                            <th style="width: 10%">证件类型</th>
                                            <th style="width: 5%">性别</th>
                                            <th style="width: 8%">民族</th>
                                            <th style="width: 8%">出生日期</th>
                                            <th style="width: 10%">户口所在地</th>
                                            <th style="width: 8%">医疗人员类别</th>
                                            <th style="width: 9%">医疗机构编号</th>
                                            <th style="width: 8%">单位编号</th>
                                            <th style="width: 25%">操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach items = "${requestScope.personlist}" var="d" >
                                        <tr>
                                            <td>${d.userId}</td>
                                            <td>${d.name}</td>
                                            <td>${d.certificateType}</td>
                                            <td>${d.sex}</td>
                                            <td>${d.nation}</td>
                                            <td>${d.birthday}</td>
                                            <td>${d.houseLoc}</td>
                                            <td>${d.medPersNum.medPersClass}</td>
                                            <td>${d.desiMedIns.desiMedInsId}</td>
                                            <td>${d.unit.unitId}</td>
                                        
                                      
                                            <td>
                                                <a href="/MICRS/person/delete?no=${d.userId}" class="btn btn-danger btn-xs" onclick="return del();"><i class="fa fa-bitbucket "></i> 删除</a>
                                                <a href="/MICRS/person/update1?no=${d.userId}" class="btn btn-info btn-xs " ><i class="fa fa-pencil"></i>修改</a>
                                                <a href="/MICRS/Manage/production/person_infor.jsp" class="btn btn-danger btn-xs"><i class="fa fa-mail-reply"></i>返回</a>
                                            </td>
                                        </tr>
                                         </c:forEach>
                                        </tbody>
