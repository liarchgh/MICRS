    ...
    <div class="main_container">
                                ...
                                <div class="row" style="height: auto">
                                    ...
                                    <table class="table table-striped projects " id="datatable">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/MICRS/delete/person" class="btn btn-danger btn-xs"><i class="fa fa-bitbucket "></i> 删除</a>
                                                <a href="/MICRS/update/person" class="btn btn-info btn-xs "><i class="fa fa-pencil"></i>修改</a>
                                                <a href="person_infor.html" class="btn btn-danger btn-xs"><i class="fa fa-mail-reply"></i>返回</a>
                                            </td>
                                        </tr>
                                         </c:forEach>
                                        </tbody>
        ...
        <footer>
            <div class="pull-right">
                ...
                <a href="person_infor.html" target="_blank" title="个人信息">个人信息</a>
                &nbsp;
                &nbsp;
