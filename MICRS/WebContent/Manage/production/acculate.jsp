            ...
            <ul class="nav side-menu">
              ...
              <li><a><i class="fa fa-edit"></i> 医疗基本信息 <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                  ...
                  <li><a href="/MICRS/Manage/production/acculate.html">医疗待遇计算参数信息维护</a></li>
                </ul>
              </li>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="">
              ...
              <ul class="dropdown-menu dropdown-usermenu pull-right">
                <li><a href="javascript:;"> 医疗待遇基本信息维护</a></li>
                <li>
                  <a href="javascript:;">
      ...
      <div class="">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="x_panel">
              <div class="x_title">
                <h2 class="drug1">欢迎进入医疗待遇计算参数信息管理！</h2>
              ...
              <div class="x_content">
                ...
                <div class="row" style="height: 600px;">
                  ...
                  <div class="col-md-55">
                    <div class="thumbnail" style="width: 280px;" id="thumbnail3">
                      <div class="image view view-first" style="height: 350px">
                        <img style="width: 100%; height: 100%; display: block;" src="/MICRS/Manage/production/images/cap.jpg" alt="image" />
                        <div class="mask" style="height: 350px">
                          <p><i class="fa fa-hand-o-down"></i>点我</p>
                          <div class="tools tools-bottom" style="height: 60px">
                            <a href="/MICRS/Manage/production/cap_line.html"><i class="fa fa-arrow-right" ></i></a>
                          </div>
                        </div>
                      </div>
                      <div class="caption">
                        <p style="text-align: center">封顶线信息查询入口！</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-55">
                    <div class="thumbnail" style="width: 280px;" id="thumbnail4">
                      <div class="image view view-first" style="height: 350px">
                        <img style="width: 100%; height: 100%; display: block;" src="/MICRS/Manage/production/images/disea2.jpg" alt="image" />
                        <div class="mask" style="height: 350px">
                          <p><i class="fa fa-hand-o-down"></i>点我</p>
                          <div class="tools tools-bottom" style="height: 60px">
                            <a href="/MICRS/Manage/production/stand_pay.html"><i class="fa fa-arrow-right"></i></a>
                          </div>
                        </div>
                      </div>
                      <div class="caption">
                        <p style="text-align: center">起付标准信息查询入口！</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-55">
                    <div class="thumbnail" style="width: 280px;" id="thumbnail5">
                      <div class="image view view-first" style="height: 350px">
                        <img style="width: 100%; height: 100%; display: block;" src="/MICRS/Manage/production/images/media1.jpg" alt="image" />
                        <div class="mask" style="height: 350px">
                          <p><i class="fa fa-hand-o-down"></i>点我</p>
                          <div class="tools tools-bottom" style="height: 60px">
                            <a href="/MICRS/Manage/production/indi_seg_ratio.html"><i class="fa fa-arrow-right"></i></a>
                          </div>
                        </div>
                      </div>
                      <div class="caption">
                        <p style="text-align: center">个人分段自费比例信息查询入口！</p>
                      </div>
                    </div>
                  </div>
