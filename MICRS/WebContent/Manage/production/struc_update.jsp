<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@page import="com.ldt.item.entity.DesiMedIns"%>
    		...
    		$.ajax({
    					...
    					success:function(data){
    						...
    						$(data).each(function(i,hc){
    							if(b == hc.hospitalId){str = str + "<option selected = 'selected' value="+hc.hospitalId+">"+hc.hospitalLevel+"</option>";
    							}else{
    		...
    		$.ajax({
    					...
    					success:function(data){
    						...
    						$(data).each(function(i,ho){
    							if(b2 == ho.hoId){str = str + "<option selected = 'selected' value="+ho.hoId+">"+ho.medInsClass+"</option>";
    							}else{
    ...
    <div class="main_container">
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>定点医疗机构信息修改<small>修改定点医疗机构信息</small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <form action="/MICRS/struc/update2" class="form-horizontal form-label-left" novalidate method = "post">

                                    <p>该页面的主要功能是进行<code>定点医疗机构基本信息</code>的修改，带<code>*</code>是<code>必填项</code>，点击此处可以跳转到<a href="/MICRS/Manage/production/struc_query.jsp">查询页面</a>
                                    </p>
                                    <span class="section">定点医疗机构信息</span>

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="strucid">定点医疗机构编号<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.dl.desiMedInsId}" id="strucid"
                                            class="form-control col-md-7 col-xs-12" name="strucid"
                                            data-validate-length-range="1,9" placeholder="九位0~9之间的数字"
                                            required="required" type="number" readonly="readonly">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.dl.serviceName}" id="strucname" class="form-control col-md-7 col-xs-12" name="strucname" placeholder="“仁和医院”，输入不超过10个字符" data-validate-length-range="1,10" required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id = "hid1" type = "hidden" value = "${requestScope.dl.hospitalId.hospitalId}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input id = "hid2" type = "hidden" value = "${requestScope.dl.hoId.hoId}">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.dl.postalCode}" id="strucpostcode" class="form-control col-md-7 col-xs-12" name="strucpostcode" placeholder="100001" required="required" type="number" data-validate-length-range="1,6">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.dl.legRepName}" id="legalname" class="form-control col-md-7 col-xs-12" name="legalname" placeholder="萌二" data-validate-length-range="1,20" required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.dl.legRepPhone}" id="legalphone" class="form-control col-md-7 col-xs-12" name="legalphone" placeholder="15663379888" required="required" type="number" data-validate-length-range="1,20">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.dl.connName}" id="cname" class="form-control col-md-7 col-xs-12" name="cname" placeholder="萌二" data-validate-length-range="1,20" required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.dl.connPhone}" id="cphone" class="form-control col-md-7 col-xs-12" name="cphone" placeholder="15663379888" required="required" type="number" data-validate-length-range="1,20">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.dl.connCell}" id="cmphone" class="form-control col-md-7 col-xs-12" name="cmphone" placeholder="15663379888" required="required" type="number" data-validate-length-range="1,20">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.dl.addr}" id="loc" class="form-control col-md-7 col-xs-12" name="loc"  data-validate-length-range="1,100" type="text">
                                        </div>
                                    </div>
        ...
        <footer>
            <div class="pull-right">
                ...
                &nbsp;
                &nbsp;
                <a href="/MICRS/Manage/production/acculate.jsp" target="_blank" title="主页">主页</a>
            </div>
            <div class="clearfix"></div>
        </footer>
