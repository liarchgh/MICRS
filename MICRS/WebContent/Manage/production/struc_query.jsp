            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2 class="drug1">欢迎进入定点医疗机构管理系统！</h2>
                            ...
                            <div class="x_content">
                                ...
                                <div class="row" style="height: auto">
                                    ...
                                    <p class="drug3">该模块主要功能是查询定点医疗机构详细信息</p>
                                                ...
                                                <form action="/MICRS/query/struc" method="post" onsubmit="return true">
                                                    <div class="" style="height: 70px;">
                                                        ...
                                                        <div id="" style="float: left; margin-left: 30px;">
                                                            <span>服务机构名称：</span><input type="text" class="input-large"
                                                                                         name="institution_name"  id="institution_name" /><br />  <br />
                                                            <span>医疗机构类别：</span>
                                                            <select id="institution_types" name="institution_types"  style="height: 25px;width: 170px" >
                                    ...
                                    <table class="table table-striped projects" id="datatable">
                                        ...
                                        <tr>
                                            ...
                                            <th style="width: 11%">服务机构名称</th>
                                            <th style="width: 8%">医院等级</th>
                                            <th style="width: 11%">医疗机构类别</th>
                                            <th style="width: 8%">邮政编码</th>
                                            <th style="width: 9%">联系人姓名</th>
                                        ...
                                        <tbody>
                                        <c:forEach items = "${requestScope.struclist}" var="d" >
                                        <tr>
                                            <td>${d.desiMedInsId}</td>
                                            <td>${d.serviceName}</td>
                                            <td>${d.hospitalId.hospitalLevel}</td>
                                            <td>${d.hoId.medInsClass}</td>
                                            <td>${d.postalCode}</td>
                                            <td>${d.connName}</td>
                                            <td>${d.connPhone}</td>
                                            <td>${d.addr}</td>
