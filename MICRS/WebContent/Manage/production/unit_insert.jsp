            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>单位信息注册<small>注册单位详细信息</small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <form action="/MICRS/unit/insert" class="form-horizontal form-label-left" novalidate method = "post">

                                    <p>该页面的主要功能是进行<code>单位基本信息</code>的注册，带<code>*</code>是<code>必填项</code>，点击此处可以跳转到<a href="/MICRS/Manage/production/unit_query.jsp">查询页面</a>
                                    </p>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="uname" class="form-control col-md-7 col-xs-12" name="uname" placeholder="数字，字母,汉字的自由自合" data-validate-length-range="5,20" required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="uaddr" class="form-control col-md-7 col-xs-12"  name="uaddr" placeholder="大连东软信息学院" required="required" type="text">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="upostcode" class="form-control col-md-7 col-xs-12" name="upostcode" placeholder="100001" required="required" type="number" data-validate-length-range="1,6">
                                        </div>
                                    </div>
                                    <div class="item form-group">
