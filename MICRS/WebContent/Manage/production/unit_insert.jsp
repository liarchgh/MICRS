    ...
    <div class="main_container">
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form action="/MICRS/unit/insert" class="form-horizontal form-label-left" novalidate method = "post">
                                    ...
                                    <p>该页面的主要功能是进行<code>单位基本信息</code>的注册，带<code>*</code>是<code>必填项</code>，点击此处可以跳转到<a href="unit_query.html">查询页面</a>
                                    </p>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="uname" class="form-control col-md-7 col-xs-12" name="uname" placeholder="数字，字母,汉字的自由自合，不超过10个字符" data-validate-length-range="5,10" required="required" type="text">
                                        </div>
                                    </div>
        ...
        <footer>
            <div class="pull-right">
                <a href="unit_infor.html" target="_blank" title="单位基本信息">单位基本信息</a>
                &nbsp;
                &nbsp;
