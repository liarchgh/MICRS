    ...
    <div class="col-md-3 left_col">
      <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
          <a href="index.jsp" class="site_title"><i class="fa fa-hospital-o"></i> <span>医疗保险中心报销系统</span></a>
        </div>
            ...
            <ul class="nav side-menu">
              <li><a><i class="fa fa-home"></i> 主页 <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                  <li><a href="index.jsp">报销系统简介</a></li>
                  <li><a href="main1.jsp">医疗基本信息简介</a></li>
                  <li><a href="main2.jsp">医疗待遇审批简介</a></li>
                  <li><a href="main3.jsp">医保中心报销简介</a></li>
                  <li><a href="main4.jsp">综合查询简介</a></li>
                  <li><a href="main5.jsp">公共业务简介</a></li>
                </ul>
              </li>

              <li><a><i class="fa fa-edit"></i> 医疗基本信息 <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                  <li><a href="drug_infor.jsp">药品信息</a></li>
                  <li><a href="project_infor.jsp">*诊疗项目信息</a></li>
                  <li><a href="dept_pro.jsp">*服务设施项目</a></li>
                  <li><a href="disea_infor.jsp">病种信息</a></li>
                  <li><a href="struc_infor.jsp">定点医疗机构信息</a></li>
                  <li><a href="acculate.jsp">医疗报销计算参数</a></li>
                </ul>
              </li>

              <li><a><i class="fa fa-desktop"></i> *医疗待遇审批 <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                  <li><a href="wait1.jsp">*人员就诊机构审批</a></li>
                  <li><a href="wait2.jsp">*特检特治审批</a></li>
                </ul>
              </li>

              <li><a><i class="fa fa-medkit"></i> 医保中心报销 <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                  <li><a href="Reimbursement.jsp">医保报销</a></li>
                </ul>
              </li>

              <li><a><i class="fa fa-table"></i> 综合查询 <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                  <li><a href="cost_query.jsp">医疗人员费用查询</a></li>
                </ul>
              </li>

              <li><a><i class="fa fa-briefcase"></i> 公共业务 <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                  <li><a href="unit_infor.jsp">单位基本信息</a></li>
                  <li><a href="person_infor.jsp">个人基本信息</a></li>
                </ul>
              </li>
            </ul>
          </div>
    ...
    <ul class="nav navbar-nav navbar-right">
      <li class="">
        <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
          <img src="images/img.jpg" alt="">用户信息
        ...
        <ul class="dropdown-menu dropdown-usermenu pull-right">
          ...
          <li><a href="login.jsp"><i class="fa fa-sign-out pull-right"></i> 注销</a></li>
        </ul>
      </li>
    ...
    <div class="right_col" role="main">
                  ...
                  <li>
                    <div class="block">
                      <div class="block_content">
                        ...
                        <p class="excerpt">医疗基本信息模块下属包含了六个模块，分别为药品信息，诊疗项目，服务设施项目，病种信息，定点医疗机构信息，医疗报销计算参数......<a href="main1.jsp">点击查看更多</a>
                        </p>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="block">
                      <div class="block_content">
                        ...
                        <p class="excerpt">医疗待遇审批模块下属包含了两个模块，分别为人员机构审批模块和特检特质审批...... <a href="main2.jsp">点击查看更多</a>
                        </p>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="block">
                      <div class="block_content">
                        <h2 class="title">
                          <a>医保中心报销</a>
                        </h2>医保中心报销为该系统的主要模块，在该模块下，用户可以在系统中进行业务的报销活动......<a href="main3.jsp">点击查看更多</a>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="block">
                      <div class="block_content">
                        ...
                        <p class="excerpt">该模块主要进医疗人员的费用查询.....<a href="main4.jsp">点击查看更多</a>
                        </p>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="block">
                      <div class="block_content">
                        ...
                        <p class="excerpt">公共业务模块主要包含了个人基本信息和单位基本信息查询......<a href="main5.jsp">点击查看更多</a>
                        </p>
                      </div>
                    </div>
                  </li>
      ...
      <footer>
        <div class="pull-right">
          <a href="index.jsp" target="_blank" title="主页">主页</a>
        </div>
        <div class="clearfix"></div>
      </footer>
      <!-- /footer content -->
