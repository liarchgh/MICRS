            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>封顶线信息添加<small>添加封顶线信息</small></h2>
                                ...
                                <form action="/MICRS/capline/insert" class="form-horizontal form-label-left" novalidate method = "post">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="cap_line" class="form-control col-md-7 col-xs-12" name="cap_line" placeholder="100.11" required="required" type="number" data-validate-length-range="1,14">
                                        </div>
                                    </div>
