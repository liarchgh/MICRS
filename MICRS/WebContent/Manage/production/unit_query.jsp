    ...
    <div class="main_container">
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2 class="drug1">欢迎进入单位基本信息查询！</h2>
                            ...
                            <div class="x_content">
                                ...
                                <div class="row" style="height: auto">
                                    ...
                                    <p class="drug3 text-muted font-13 m-b-30">该模块主要功能为对单位信息进行查询、增加、删除、修改操作</p>

                                    <div class="container-fluid">
                                        <div class="row-fluid">
                                            <form action="/MICRS/query/unit" method="post">
                                                <div class="" style="height: 90px;">
                                                    <div id="" style="float: left; mar">
                                                        <span><font color="black">单位编码：</font></span><input type="text" class="input-large"
                                                                                                            name="unitid" id = "unitid"/><br />  <br />
                                                        <span><font color="black">单位名称：</font></span><input
                                                            type="text" class="input-large" name="unitname" id ="unitname" />
                                                    </div>
                                                    <div class="btn-toolbar"
                                                         style="float: left;  margin-left: 40px; margin-top: 45px">
                                                        <font color="#6495ed"> <input type="submit" value="查询" class="btn"/></font>
                                                    </div>
                                                </div>
                                            </form>
                                            <!--<button id="reg" class="btn btn-primary"-->
                                            <!--style="float: right; margin-top: -50px; margin-right: 400px;">-->
                                            <!--<a href="/MInsurance/fill-medicine-form.jsp" style="color: white;"><i-->
                                            <!--class="icon-plus"></i>添加新的药品信息</a>-->
                                            <!--</button>-->
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-striped projects " id="datatable">
                                        <thead>
                                        <tr>
                                            <th style="width: 8%">单位编号</th>
                                            <th style="width: 10%">单位名称</th>
                                            <th style="width: 10%">单位类型</th>
                                        ...
                                        <tbody>
                                        <c:forEach items = "${requestScope.uilist}" var="u">
                                        <tr>
                                            <td>${u.unitId}</td>
                                            <td>${u.unitName}</td>
                                            <td>${u.unitType}</td>
                                            ...
                                            <td>${u.phone}</td>
                                            <td>
                                                <a href="/MICRS/unit/delete?no=${u.unitId}" class="btn btn-danger btn-xs" onclick="return del();"><i class="fa fa-bitbucket "></i> 删除</a>
                                                <a href="/MICRS/unit/update1?no=${u.unitId} " class="btn btn-info btn-xs " ><i class="fa fa-pencil"></i>修改</a>
                                                <a href="/MICRS/Manage/production/unit_infor.jsp" class="btn btn-danger btn-xs"><i class="fa fa-mail-reply"></i>返回</a>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                        </tbody>
        ...
        <footer>
            <div class="pull-right">
            	<a href="/MICRS/Manage/production/unit_insert.jsp" target="_blank" title="注册页面">转到注册页面</a>
                &nbsp;
                &nbsp;
