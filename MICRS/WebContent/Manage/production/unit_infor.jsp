                                    ...
                                    <div class="col-md-55">
                                        <div class="thumbnail" style="width: 280px;" id="thumbnail1">
                                            <div class="image view view-first" style="height: 350px">
                                                <img style="width: 100%; height: 100%; display: block;" src="/MICRS/Manage/production/images/unit.jpg" alt="image" />
                                                <div class="mask" style="height: 350px">
                                                    <p><i class="fa fa-hand-o-down"></i>点我</p>
                                                    <div class="tools tools-bottom" style="height: 60px">
                                                        <a href="/MICRS/Manage/production/unit_query.jsp"><i class="fa fa-arrow-right" id="right1"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                                <p style="text-align: center">单位信息查询入口！</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-55">
                                        <div class="thumbnail" style="width: 280px;" id="thumbail2">
                                            <div class="image view view-first" style="height: 350px">
                                                <img style="width: 100%; height: 100%; display: block;" src="/MICRS/Manage/production/images/unit2.jpg" alt="image" />
                                                <div class="mask" style="height: 350px">
                                                    <p><i class="fa fa-hand-o-down"></i>点我</p>
                                                    <div class="tools tools-bottom" style="height: 60px">
                                                        <a href="/MICRS/Manage/production/unit_insert.jsp"><i class="fa fa-arrow-right" id="right2"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                                <p style="text-align: center">单位信息增加入口！</p>
                                            </div>
                                        </div>
                                    </div>
