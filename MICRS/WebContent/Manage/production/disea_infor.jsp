          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><font color="black">病种信息</font></h3>
              </div>
                      ...
                      <div class="col-md-55">
                        <div class="thumbnail" style="width: 280px;" id="thumbnail1">
                          <div class="image view view-first" style="height: 350px">
                            <img style="width: 100%; height: 100%; display: block;" src="/MICRS/Manage/production/images/disea.jpg" alt="image" />
                            <div class="mask" style="height: 350px">
                              <p><i class="fa fa-hand-o-down"></i>点我</p>
                              <div class="tools tools-bottom" style="height: 60px">
                                <a href="/MICRS/Manage/production/disea_query.jsp"><i class="fa fa-arrow-right" id="right1"></i></a>
                              </div>
                            </div>
                          </div>
                          <div class="caption">
                            <p style="text-align: center">病种信息查询入口！</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-55">
                        <div class="thumbnail" style="width: 280px;" id="thumbail2">
                          <div class="image view view-first" style="height: 350px">
                            ...
                            <div class="mask" style="height: 350px">
                              <p><i class="fa fa-hand-o-down"></i>点我</p>
                              <div class="tools tools-bottom" style="height: 60px">
                                <a href="/MICRS/Manage/production/disea_insert.jsp"><i class="fa fa-arrow-right" id="right2"></i></a>
                              </div>
                            </div>
                          </div>
                          <div class="caption">
                            <p style="text-align: center">病种信息增加入口！</p>
                          </div>
                        </div>
                      </div>
