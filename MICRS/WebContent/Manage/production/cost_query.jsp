                ...
                <div class="row" style="height: auto">
                  ...
                  <table class="table table-striped projects " id="datatable">
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="/MICRS/query/cost" class="btn btn-primary btn-xs"><i class="fa fa-folder "></i> 查询就诊信息</a>
                        <a href="annual_account.html" class="btn btn-info btn-xs "><i class="fa fa-folder"></i>年度费用累计信息</a>
                      </td>
                    </tr>
                    </c:forEach>
                    </tbody>
