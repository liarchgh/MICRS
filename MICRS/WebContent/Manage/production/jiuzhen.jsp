                ...
                <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="/MICRS/Manage/production/images/img.jpg" alt="">就诊信息查询
                                <span class=" fa fa-angle-down"></span>
                            </a>
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                <li><a href="javascript:;"> 就诊信息</a></li>
                                <li>
                                    <a href="javascript:;">
                                ...
                                <div class="row" style="height: auto">
                                    ...
                                    <table class="table table-striped projects " id="datatable">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/MICRS/chufang/query?no=${p.outpatientNum}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> 处方明细</a>
