    ...
    <div class="main_container">
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form action="/MICRS/insert/diseaseInformation" class="form-horizontal form-label-left" novalidate method = "post">
                                    ...
                                    <p>该页面的主要功能是进行<code>病种基本信息</code>的注册，带<code>*</code>是<code>必填项</code>，点击此处可以跳转到<a href="/MICRS/Manage/production/disea_query.jsp">查询页面</a>
                                    </p>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="diseaname" class="form-control col-md-7 col-xs-12" name="diseaname" placeholder="心脏病" data-validate-length-range="60" required="required" type="text">
                                        </div>
                                    </div>
        ...
        <footer>
            <div class="pull-right">
                <a href="/MICRS/Manage/production/disea_infor.jsp" target="_blank" title="病种信息">返回病种信息</a>
                &nbsp;
                &nbsp;
