            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>封顶线信息修改<small>修改封顶线信息</small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <form action="/MICRS/capline/update2" class="form-horizontal form-label-left" novalidate method = "post">

                                    <p>该页面的主要功能是进行<code>封顶线基本信息</code>的修改，带<code>*</code>是<code>必填项</code>，点击此处可以跳转到<a href="/MICRS/Manage/production/cap_line.jsp">查询页面</a>
                                    </p>
                                    <span class="section">封顶线信息</span>

                                    <!-- <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cap_id">封顶线编号<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="cap_id" class="form-control col-md-7 col-xs-12" name="cap_id"  data-validate-length-range="1,9" placeholder="九位0~9之间的数字" required="required" type="number" readonly="readonly">
                                        </div>
                                    </div> -->

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="med_per_class_no">医疗人员类别编号<span class="required">*</span></label>
                                        
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.clist.medpers.medPersNum }" id="med_per_class_no" class="form-control col-md-7 col-xs-12" name="med_per_class_no" required="required" type="number" data-validate-length-range="1,50" readonly = "readonly">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.clist.medpers.medPersClass }" id="med_per_class" class="form-control col-md-7 col-xs-12" name="med_per_class" required="required" type="text" data-validate-length-range="1,50" readonly = "readonly">
                                        </div>
                                    </div>

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cap_line">封顶线<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.clist.capLine }" id="cap_line" class="form-control col-md-7 col-xs-12" name="cap_line" placeholder="100.11" required="required" type="number" data-validate-length-range="1,14">
                                        </div>
                                    </div>
