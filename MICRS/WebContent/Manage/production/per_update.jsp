...
<head>
		...
		$.ajax({
					...
					success:function(data){
						...
						$(data).each(function(i,mp){
							if(b1 == mp.medPersNum){str = str + "<option selected = 'selected' value="+mp.medPersNum+">"+mp.medPersClass+"</option>";
							}else{
	...
	$(function(){
		$.ajax({
					...
					success:function(data){
						...
						var b3 = $("#h3").val();
						str = str + "<option></option>";
						$(data).each(function(i,ui){
							if(b3 == ui.unitId){str = str + "<option selected = 'selected' value="+ui.unitId+">"+ui.unitName+"</option>";
							}else{str = str + "<option value="+ui.unitId+">"+ui.unitName+"</option>";
							}
						});
						$("#unit_code").html(str);
					},
	...
	$(function(){
		$.ajax({
					url:"/MICRS/person/desimedins/ajax",
					type:"GET",
					dataType:"json",
					success:function(data){
						var str = "";
						var b2 = $("#h2").val();
						str = str + "<option></option>";
						$(data).each(function(i,dmi){
							if(b2 == dmi.desiMedInsId){str = str + "<option selected = 'selected' value="+dmi.desiMedInsId+">"+dmi.serviceName+"</option>";
							}else{							str = str + "<option value="+dmi.desiMedInsId+">"+dmi.serviceName+"</option>";
}
						});
						$("#hospital_code").html(str);
					},
					error:function(){
						alert("error");
					}
    ...
    <div class="main_container">
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>个人信息注册<small>注册个人详细信息</small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <form action="/MICRS/person/update2" class="form-horizontal form-label-left" novalidate method = "post">
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pid">人员编号<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value ="${requestScope.pl.userId}" id="pid" class="form-control col-md-7 col-xs-12" name="pid"  data-validate-length-range="1,9" placeholder="六位0~9之间的数字" required="required" type="number" readonly="readonly">
                                        </div>
                                    </div>

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pname">人员姓名 <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value ="${requestScope.pl.name}" id="pname" class="form-control col-md-7 col-xs-12" name="pname" placeholder="“张三”，输入不超过10个字符" data-validate-length-range="1,10" required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" id="pcardtype" name="pcardtype" style="width: 583px">
                                                ...
                                                <c:if test="${requestScope.pl.certificateType.equals('身份证') }">
                                                <option selected = "selected">身份证</option>
                                                </c:if>
                                                <c:if test="${!requestScope.pl.certificateType.equals('身份证') }">
                                                <option>身份证</option>
                                                </c:if>
                                                <c:if test="${requestScope.pl.certificateType.equals('军人证') }">
                                                <option selected = "selected">军人证</option>
                                                </c:if>
                                                <c:if test="${!requestScope.pl.certificateType.equals('军人证') }">
                                                <option>军人证</option>
                                                </c:if>
                                                <c:if test="${requestScope.pl.certificateType.equals('学生证') }">
                                                <option selected = "selected">学生证</option>
                                                </c:if>
                                                <c:if test="${!requestScope.pl.certificateType.equals('学生证') }">
                                                <option>学生证</option>
                                                </c:if>
                                                <c:if test="${requestScope.pl.certificateType.equals('通行证') }">
                                                <option selected = "selected">学生证</option>
                                                </c:if>
                                                <c:if test="${!requestScope.pl.certificateType.equals('通行证') }">
                                                <option>学生证</option>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pnation">民族<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value ="${requestScope.pl.nation}" id="pnation" class="form-control col-md-7 col-xs-12" name="pnation"  data-validate-length-range="1,10" placeholder="1~10位字符" required="required" type="text">
                                        </div>
                                    </div>

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pbirthday">出生日期<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value ="${requestScope.pl.birthday}" id="pbirthday" class="form-control col-md-7 col-xs-12" name="pbirthday" required="required" type="date">
                                        </div>
                                    </div>

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pworkday">参加工作日期<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value ="${requestScope.pl.workDate}" id="pworkday" class="form-control col-md-7 col-xs-12" name="pworkday" required="required" type="date">
                                        </div>
                                    </div>

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pretireday">退休日期<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value ="${requestScope.pl.retire}" id="pretireday" class="form-control col-md-7 col-xs-12" name="pretireday" required="required" type="date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" id="hukouxingzhi" name="hukouxingzhi" style="width: 583px">
                                                ...
                                                <c:if test="${requestScope.pl.houseType.equals('城镇') }">
                                                <option selected = "selected">城镇</option>
                                                </c:if>
                                                <c:if test="${!requestScope.pl.houseType.equals('城镇') }">
                                                <option>城镇</option>
                                                </c:if>
                                                <c:if test="${requestScope.pl.houseType.equals('农村') }">
                                                <option selected = "selected">农村</option>
                                                </c:if>
                                                <c:if test="${!requestScope.pl.houseType.equals('农村') }">
                                                <option>农村</option>
                                                </c:if>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input type = "hidden" id = "h1" value="${requestScope.pl.medPersNum.medPersNum}">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="hospital_code">定点医疗机构名称 <span class="required">*</span></label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                        	<input type = "hidden" id = "h2" value="${requestScope.pl.desiMedIns.desiMedInsId}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input type = "hidden" id = "h3" value="${requestScope.pl.unit.unitId}">
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="hukouloc">户口所在地
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value="${requestScope.pl.houseLoc}" id="hukouloc" class="form-control col-md-7 col-xs-12" name="hukouloc" placeholder="不超过30个字符" data-validate-length-range="1,30" type="text">
                                        </div>
                                    </div>
        ...
        <footer>
            <div class="pull-right">
                <a href="/MICRS/Manage/production/person_infor.jsp" target="_blank" title="个人信息">个人信息</a>
                &nbsp;
                &nbsp;
