...
<head>
    ...
    <script src="/MICRS/Manage/production/assets/js/checkUser.js"></script>
...
<div class="page-container">
        <h1 style="color:#003ada">Register</h1>
            <form action="/MICRS/SignUp" method="post">
                <input type="text" name="username" class="username" placeholder="姓名" id="username" onblur="checkUsername()" onkeyup="restrictUsername()"/>
                <span id="usernameS"></span>
                <input type="password" name="password" class="password" placeholder="密码：（8-20位的字母加数字，不可以是纯数字或纯字母）" id="pass1" onblur="checkPassword1();checkPassword2();"/>
                <span id="pass1S"></span>
                <input type="password" class="password" placeholder="请重复输入密码：" id="pass2" onkeyup="checkPassword2()"/>
                <span id="pass2S"></span>
                <button type="submit">确认注册</button>
            </form>
    <div>
        <br>
        <a href="/MICRS/Manage/production/login.jsp" title="signUp" style="color: #404ada;">已有账号，去登录></a>
    </div>
</div>
<br>
<br>
