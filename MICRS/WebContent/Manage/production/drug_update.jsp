...
<head>
    ...
    <script type="text/javascript">
    	 ...
    	 $(function(){
    		$.ajax({
    					url:"/MICRS/druglist/hospitalclass/ajax",
    					type:"GET",
    					dataType:"json",
    					success:function(data){
    						...
    						$(data).each(function(i,hc){
    							if( b == hc.hospitalId){
    							str = str + "<option selected = 'selected' value="+hc.hospitalId+">"+hc.hospitalLevel+"</option>";
    						}
    						else{
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>药品信息修改<small>修改药品详细信息</small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <form action="/MICRS/druglist/update2" class="form-horizontal form-label-left" novalidate method = "post">

                                    <p>该页面的主要功能是进行<code>药品基本信息</code>的修改，带<code>*</code>是<code>必填项</code>，点击此处可以跳转到<a href="/MICRS/Manage/production/drug_query.jsp">查询页面</a>
                                    </p>
                                    <span class="section">药品基本信息</span>

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="durgid">药品编号<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.dlist.medicineCode }" id="durgid" class="form-control col-md-7 col-xs-12" name="durgid"  data-validate-length-range="1,14" placeholder="十四位0~9之间的数字" required="required" type="number" readonly="readonly">
                                        </div>
                                    </div>

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="drugname">药品名称 <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.dlist.medicineName }" id="drugname" class="form-control col-md-7 col-xs-12" name="drugname" placeholder="“阿莫西林”，输入不超过20个字符" data-validate-length-range="1,20" required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" id="chargetype" name="chargetype" style="width: 583px">
                                                <c:if test="${requestScope.dlist.chargeType.equals('甲')}">
                                                <option selected = "selected">甲</option>
                                                </c:if>
                                                <c:if test="${!requestScope.dlist.chargeType.equals('甲')}">
                                                <option >甲</option>
                                                </c:if>
                                                <c:if test="${requestScope.dlist.chargeType.equals('乙')}">
                                                <option selected = "selected">乙</option>
                                                </c:if>
                                                <c:if test="${!requestScope.dlist.chargeType.equals('乙')}">
                                                <option >乙</option>
                                                </c:if>
                                                <c:if test="${requestScope.dlist.chargeType.equals('丙')}">
                                                <option selected = "selected">丙</option>
                                                </c:if>
                                                <c:if test="${!requestScope.dlist.chargeType.equals('丙')}">
                                                <option >丙</option>
                                                </c:if>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" id="chufangsyb" name="chufangsyb" style="width: 583px">
                                                ...
                                                <c:if test="${requestScope.dlist.prescriptionSign.equals('是') }">
                                                <option selected = "selected">是</option>
                                                </c:if>
                                                <c:if test="${!requestScope.dlist.prescriptionSign.equals('是') }">
                                                <option>是</option>
                                                </c:if>
                                                <c:if test="${requestScope.dlist.prescriptionSign.equals('否') }">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" id="chargeclass" name="chargeclass" style="width: 583px">
                                                ...
                                                <c:if test="${requestScope.dlist.chargeLevel.equals('一级') }">
                                                <option selected = "selected">一级</option>
                                                </c:if>
                                                <c:if test="${!requestScope.dlist.chargeLevel.equals('一级') }">
                                                <option>一级</option>
                                                </c:if>
                                                <c:if test="${requestScope.dlist.chargeLevel.equals('二级') }">
                                                <option selected = "selected">二级</option>
                                                </c:if>
                                                <c:if test="${!requestScope.dlist.chargeLevel.equals('二级') }">
                                                <option>二级</option>
                                                </c:if>
                                                <c:if test="${requestScope.dlist.chargeLevel.equals('三级') }">
                                                <option selected = "selected">三级</option>
                                                </c:if>
                                                <c:if test="${!requestScope.dlist.chargeLevel.equals('三级') }">
                                                <option>三级</option>
                                                </c:if>
                                                <c:if test="${requestScope.dlist.chargeLevel.equals('四级') }">
                                                <option selected = "selected">三级</option>
                                                </c:if>
                                                <c:if test="${!requestScope.dlist.chargeLevel.equals('四级') }">
                                                <option>三级</option>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="drugunit">药品剂量单位 <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  value = "${requestScope.dlist.drugDosageUnit }" id="drugunit" class="form-control col-md-7 col-xs-12" name="drugunit"  data-validate-length-range="1,16" required="required" type="text">
                                        </div>
                                    </div>

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="top_price">最高限价<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.dlist.priceCeiling }" id="top_price" class="form-control col-md-7 col-xs-12" name="top_price"  data-validate-length-range="1,12" placeholder="1111.11" required="required" type="number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" id="yuanneisyb" name="yuanneisyb" style="width: 583px">
                                                ...
                                                <c:if test="${requestScope.dlist.hospitalPreparationMark.equals('是') }">
                                                <option selected = "selected">是</option>
                                                </c:if>
                                                <c:if test="${!requestScope.dlist.hospitalPreparationMark.equals('是') }">
                                                <option>是</option>
                                                </c:if>
                                                <c:if test="${requestScope.dlist.hospitalPreparationMark.equals('否') }">
                                                <option selected = "selected">否</option>
                                                </c:if>
                                                <c:if test="${!requestScope.dlist.hospitalPreparationMark.equals('否') }">
                                                <option>否</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" id="checking" name="checking" style="width: 583px">
                                               ...
                                               <c:if test="${requestScope.dlist.approvalMarks.equals('是') }">
                                                <option selected = "selected">是</option>
                                                </c:if>
                                                <c:if test="${!requestScope.dlist.approvalMarks.equals('是') }">
                                                <option>是</option>
                                                </c:if>
                                                <c:if test="${requestScope.dlist.approvalMarks.equals('否') }">
                                                <option selected = "selected">否</option>
                                                </c:if>
                                                <c:if test="${!requestScope.dlist.approvalMarks.equals('否') }">
                                                <option>否</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                        	<input type = "hidden" id = "hid1" value = "${requestScope.dlist.hospitalID.hospitalId}">
