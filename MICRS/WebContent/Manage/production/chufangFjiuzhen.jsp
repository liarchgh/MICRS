    ...
    <div class="main_container">
                                ...
                                <div class="row" style="height:auto">
                                    ...
                                    <table class="table table-striped projects " id="datatable">
                                        ...
                                        <tr>
                                            ...
                                            <td>${p.account}</td>
                                            <td>
                                                <a href="/MICRS/Manage/production/prescription.jsp?${p.outpatientNum}&${p.medicineCode.medicineCode}" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i>修改</a>
                                                <a href="/MICRS/prescriptiondetail/delete?OUTPATIENT_NUM=${p.outpatientNum}&MEDICINE_CODE=${p.medicineCode.medicineCode}" class="btn btn-danger btn-xs"><i class="fa fa-mail-reply"></i>删除</a>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                        </tbody>
        ...
        <footer>
            <div class="pull-right">
                <a id="setUrl" href="/MICRS/Manage/production/prescription.jsp?" target="_blank" title="添加处方明细">添加处方明细</a>
            </div>
            <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
...
window.onload = function() {
	...
	now = now.substring(now.indexOf("?") + 4, now.length);
	var paraString = now.substring(0, now.indexOf("&"));
	var url = document.getElementById("setUrl");
	url.href = url.href + paraString;
}
</script>
</body>
</html>