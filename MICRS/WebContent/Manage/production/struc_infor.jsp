      ...
      <div class="">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="x_panel">
              <div class="x_title">
                <h2 class="drug1">欢迎进入定点医疗机构信息管理！</h2>
                      ...
                      <div class="image view view-first" style="height: 350px">
                        ...
                        <div class="mask" style="height: 350px">
                          ...
                          <div class="tools tools-bottom" style="height: 60px">
                            <a href="/MICRS/Manage/production/struc_query.jsp"><i class="fa fa-arrow-right" id="right1"></i></a>
                          </div>
                        </div>
                      </div>
                      <div class="caption">
                        <p style="text-align: center">定点医疗机构信息查询入口！</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-55">
                    <div class="thumbnail" style="width: 280px;" id="thumbail2">
                      <div class="image view view-first" style="height: 350px">
                        <img style="width: 100%; height: 100%; display: block;" src="/MICRS/Manage/production/images/struc.jpg" alt="image" />
                        <div class="mask" style="height: 350px">
                          <p><i class="fa fa-hand-o-down"></i>点我</p>
                          <div class="tools tools-bottom" style="height: 60px">
                            <a href="/MICRS/Manage/production/struc_insert.jsp"><i class="fa fa-arrow-right" id="right2"></i></a>
                          </div>
                        </div>
                      </div>
                      <div class="caption">
                        <p style="text-align: center">定点医疗机构信息增加入口！</p>
                      </div>
                    </div>
                  </div>
