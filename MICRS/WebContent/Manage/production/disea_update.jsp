    		...
    		$.ajax({
    					...
    					success:function(data){
    						...
    						$(data).each(function(i,dpdl){
    							if(b == dpdl.diseaseNum){str = str + "<option selected = 'selected' value="+dpdl.diseaseNum+">"+dpdl.disClass+"</option>";
    							}else{
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>疾病信息修改<small>修改疾病的详细信息</small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <form action="/MICRS/diseaseinformation/update2" class="form-horizontal form-label-left" novalidate method = "post">

                                    <p>该页面的主要功能是进行<code>疾病基本信息</code>的修改，带<code>*</code>是<code>必填项</code>，点击此处可以跳转到<a href="/MICRS/Manage/production/disea_query.jsp">查询页面</a>
                                    </p>
                                    <span class="section">疾病基本信息</span>

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="diseid">疾病编码<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.d.disNum }" id="diseid" class="form-control col-md-7 col-xs-12" name="diseid"  data-validate-length-range="1,9" placeholder="九位0~9之间的数字" required="required" type="number" readonly="readonly">
                                        </div>
                                    </div>

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="disename">疾病名称 <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value = "${requestScope.d.disName }" id="disename" class="form-control col-md-7 col-xs-12" name="disename" placeholder="心脏病" data-validate-length-range="1,60" required="required" type="text">
                                        </div>
                                    </div>

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pcardtype">疾病种类<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                        	<input type = "hidden" id = "hid" value = "${requestScope.d.diseaseNum.diseaseNum }">
                                            <select class="form-control col-md-7 col-xs-12" id="diseatype" name="diseatype">
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="hukouxingzhi">病种报销标志</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" id="diseasyb" name="diseasyb" >
                                            	<c:if test="${requestScope.d.disReimbSign.equals('是') }">
                                                <option selected = "selected">是</option>
                                                </c:if>
                                                <c:if test="${!requestScope.d.disReimbSign.equals('是') }">
                                                <option>是</option>
                                                </c:if>
                                                <c:if test="${requestScope.d.disReimbSign.equals('否') }">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                            <a href="/MICRS/Manage/production/disea_query.jsp">
