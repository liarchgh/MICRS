    ...
    <div class="main_container">
                                    ...
                                    <table class="table table-striped projects" id="datatable">
                                        ...
                                        <tr>
                                           <td>${d.medicineCode}</td>
                                            ...
                                            <td style="width: 25%">
                                                <a href="/MICRS/update/drug" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i>修改</a>
                                                <a href="/MICRS/delete/drug" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> 删除</a>
                                                <a href="/MICRS/details/drug" class="btn btn-info btn-xs"><i class="fa fa-folder"></i> 详细信息 </a>
                                            </td>
                                        </tr>
        ...
        <footer>
            <div class="pull-right">
                <a href="drug_infor.html" target="_blank" title="药品信息">返回</a>
                &nbsp;
                &nbsp;
                <a href="drug_insert.html" target="_blank" title="转到添加页面">转到添加页面</a>
                &nbsp;
                &nbsp;
