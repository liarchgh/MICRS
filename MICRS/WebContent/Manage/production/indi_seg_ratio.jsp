            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2 class="drug1">欢迎进入个人分段自费比例信息维护！</h2>
                            ...
                            <div class="x_content">
                                ...
                                <div class="row" style="height: auto">
                                    ...
                                    <p class="drug3">该模块主要功能是个人分段自费比例信息维护</p>
                                        <div class="container-fluid">
                                            <div class="row-fluid">
                                                <form action="/MICRS/query/indisegratio" method="post" onsubmit="return true" >
                                                    <div class="" style="height: 70px;">
                                                        <div  style="float: left;">
                                                            <span>个人自费编号：</span><input type="text" value=""
                                                                                         class="input-large" name="personid" id="personid"/><br /> <br />
                                            ...
                                            <table class="table table-striped projects" id="datatable">
                                                <thead>
                                                <tr>
                                                    <th style="width: 10%">个人自费编号</th>
                                                    <th style="width: 10%">医疗人员类别</th>
                                                    <th style="width: 8%">医疗类别</th>
                                                    <th style="width: 8%">医院等级</th>
                                                    <th style="width: 10%">上限金额</th>
                                                    <th style="width: 10%">下限金额</th>
                                                    <th style="width: 8%">报销比例</th>
                                                    <th style="width: 40%">操作</th>
                                                </tr>

                                                </thead>
                                                <tbody>
                                                <c:forEach items = "${requestScope.indilist}" var="d" >
                                                <tr>
                                                    <td>${d.id}</td>
                                            		<td>${d.indiSeg.indiSeg}</td>
                                            		<td>${d.medPers.medPersClass}</td>
                                            		<td>${d.hospital.hospitalLevel}</td>
                                                  	<td>${d.topMon}</td>
                                            		<td>${d.bootomMon}</td>
                                            		<td>${d.ratio}</td>
                                                    <td style="width: 25%">
                                                        <a href="/MICRS/indisegratio/update1?no=${d.id}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i>修改个人自费信息</a>
                                                        <a href="/MICRS/indisegratio/delete?no=${d.id}" class="btn btn-danger btn-xs" onclick="return del();"><i class="fa fa-bitbucket" ></i> 删除信息</a>
                                                    </td>
                                                </tr>
                                                 </c:forEach>
                                                </tbody>
                ...
                <footer>
                    <div class="pull-right">
                        ...
                        &nbsp;
                        &nbsp;
                        <a href="/MICRS/Manage/production/indi_seg_ratio_insert.jsp" target="_blank" title="添加个人分段自费比例">转到添加页面</a>
                        &nbsp;
                        &nbsp;
