                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                ...
                                <li><a href="login.html"><i class="fa fa-sign-out pull-right"></i> 个人分段自费比例</a></li>
                            </ul>
                        </li>
                        </li>
                    </ul>
            ...
            <div class="">
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <table class="table table-striped projects" id="datatable">
                                                ...
                                                <tr>
                                            		...
                                            		<td>${d.ratio}</td>
                                                    <td style="width: 25%">
                                                        <a href="/MICRS/update/indisegratio" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i>修改个人自费信息</a>
                                                        <a href="/MICRS/delete/indisegratio" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> 删除信息</a>
                                                    </td>
                                                </tr>
                                                 </c:forEach>
                                                </tbody>
                ...
                <footer>
                    <div class="pull-right">
                        ...
                        &nbsp;
                        &nbsp;
                        <a href="indi_seg_ratio_insert.html" target="_blank" title="添加个人分段自费比例">转到添加页面</a>
                        &nbsp;
                        &nbsp;
