<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@page import="com.ldt.item.entity.IndiSegRatio"%>
    		...
    		$.ajax({
    					...
    					success:function(data){
    						...
    						$(data).each(function(i,mp){
    							if(b == mp.medPersNum){
    								str = str + "<option selected = 'selected' value="+mp.medPersNum+">"+mp.medPersClass+"</option>";
								}else{
    		...
    		$.ajax({
    					...
    					success:function(data){
    						...
    						$(data).each(function(i,ilist){
    							if(b == ilist.indiSegID){str = str + "<option selected = 'selected' value="+ilist.indiSegID+">"+ilist.indiSeg+"</option>";
    							}else{
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form action="/MICRS/indisegratio/update2" class="form-horizontal form-label-left" novalidate method = "post">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value ="${requestScope.inlist.id}" id="ppid" class="form-control col-md-7 col-xs-12" name="ppid"  data-validate-length-range="1,9" placeholder="六位0~9之间的数字" required="required" type="number" readonly="readonly">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type = "hidden" id = "hid1" value = "${requestScope.inlist.medPers.medPersNum}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input type = "hidden" id = "hid2" value = "${requestScope.inlist.hospital.hospitalId}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input type = "hidden" id = "hid3" value = "${requestScope.inlist.indiSeg.indiSegID}">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value ="${requestScope.inlist.topMon}" id="top_m" class="form-control col-md-7 col-xs-12" name="top_m"  data-validate-length-range="1,14" placeholder="1111.11" required="required" type="number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value ="${requestScope.inlist.bootomMon}" id="bottom_m" class="form-control col-md-7 col-xs-12" name="bottom_m"  data-validate-length-range="1,9" placeholder="111.11" required="required" type="number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input value ="${requestScope.inlist.ratio}" id="bratio" class="form-control col-md-7 col-xs-12" name="bratio"  data-validate-length-range="1,9" placeholder="九位0~9之间的数字" required="required" type="number">
                                        </div>
                                    </div>
