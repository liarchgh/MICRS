...
<head>
    ...
    <script type="text/javascript">
    		...
    		$.ajax({
    					...
    					success:function(data){
    						...
    						$(data).each(function(i,ui){
    							str = str + "<option value="+ui.unitId+">"+ui.unitName+"</option>";
    						});
    						$("#unit_code").html(str);
    					},
    					error:function(){
    	...
    	$(function(){
    		$.ajax({
    					url:"/MICRS/person/hospitalorganization/ajax",
    					type:"GET",
    					dataType:"json",
    					success:function(data){
    						var str = "";
    ...
    <div class="main_container">
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form action="/MICRS/person/insert" class="form-horizontal form-label-left" novalidate method = "post">
                                    ...
                                    <p>该页面的主要功能是进行<code>个人基本信息</code>的注册，带<code>*</code>是<code>必填项</code>，点击此处可以跳转到<a href="per_query.html">查询页面</a>
                                    </p>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="pname" class="form-control col-md-7 col-xs-12" name="pname" placeholder="“张三”，输入不超过10个字符" data-validate-length-range="1,10" required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cid">证件ID <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="cid" class="form-control col-md-7 col-xs-12" name="cid" placeholder="输入不超过20个字符" data-validate-length-range="1,20" required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="pnation" class="form-control col-md-7 col-xs-12" name="pnation"  data-validate-length-range="1,10" placeholder="1~10位字符" required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="pbirthday" class="form-control col-md-7 col-xs-12" name="pbirthday" required="required" type="date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="pworkday" class="form-control col-md-7 col-xs-12" name="pworkday" required="required" type="date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="pretireday" class="form-control col-md-7 col-xs-12" name="pretireday" required="required" type="date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="hukouloc" class="form-control col-md-7 col-xs-12" name="hukouloc" placeholder="不超过30个字符" data-validate-length-range="1,30" type="text">
                                        </div>
                                    </div>
        ...
        <footer>
            <div class="pull-right">
                <a href="per_query.html" target="_blank" title="个人基本信息">个人基本信息</a>
                &nbsp;
                &nbsp;
