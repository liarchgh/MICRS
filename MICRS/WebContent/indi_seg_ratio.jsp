                                        ...
                                        <div class="container-fluid">
                                                    ...
                                                    <div class="" style="height: 70px;">
                                                        <div  style="float: left;">
                                                            <span>个人自费编号：</span><input type="text" value=""
                                                                                         class="input-large" name="institution_id" id="institution_id"/><br /> <br />
                                            ...
                                            <table class="table table-striped projects" id="datatable">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>一级</td>
                                                    <td style="width: 25%">
                                                        <a href="indi_seg_ratio_update.html" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i>修改个人自费信息</a>
                                                        <a href="#" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> 删除信息</a>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
